...
/**
*    @file   protocol_name.h
*    @brief    Array of protocol names
*/


#define NumProtos	138		/**<	Total protocols available */
#define MAX_PROTO_STR 8 	/**<	Max str size for each protocol_name */
